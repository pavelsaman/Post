...
my $branches = $post->$method({ Day => "Friday", Time => "10:00" });
...
my $branches = $post->$method({ Day => "Friday", Time => "09:00" });
...
my $branches = $post->$method({ Day => "Saturday", Time => "09:00" });
